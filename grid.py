...
class Grid(object):
        ...
        for i in range(r):
            for j in range(c):
                if self.grid[i][j] == EMPTY:
                    ...
                    newGrid[i][j] = self.updateCell(
                        i, j, majorDeaths, minorDeaths)
    ...
    def isEnemyAnt(self, currAnt, adjAnt, expectedType):
        if adjAnt == EMPTY:
            return False
        elif ((currAnt.tribe != adjAnt.tribe) and
            adjAnt.antType == expectedType):
            return True
        else:
            return False
    ...
    def printGrid(self):
        ...
        for i in range(r):
            for j in range(c):
                ...
                elif (self.grid[i][j].tribe == "red" and
                    self.grid[i][j].antType == "minor"):
                    print colorama.Back.MAGENTA + " ",
                elif (self.grid[i][j].tribe == "red" and
                    self.grid[i][j].antType == "major"):
                    print colorama.Back.RED + " ",
                elif (self.grid[i][j].tribe == "blue" and
                    self.grid[i][j].antType == "minor"):
